...
import net.sourceforge.dynamicgmf.diagram.edit.policies.EcoreModelTextSelectionEditPolicy;
 ...
 * @generated
 */
public class EClassNameEditPart extends CompartmentEditPart
	...
	protected Image getLabelIcon() {
		...
		return EcoreModelElementTypes.getImage(parserElement.eClass());
	}
	...
	public void setLabelText(String text) {
		...
		if (pdEditPolicy instanceof EcoreModelTextSelectionEditPolicy) {
			((EcoreModelTextSelectionEditPolicy) pdEditPolicy).refreshFeedback();
		}
	}
	...
	public IParser getParser() {
		if (parser == null) {
			...
			IAdaptable hintAdapter = new EcoreModelParserProvider.HintAdapter(
					EcoreModelElementTypes.getElementType(eClass), getParserElement(),
					parserHint);
	...
	protected DirectEditManager getManager() {
		if (manager == null) {
			setManager(new TextDirectEditManager(this, TextDirectEditManager
					.getTextCellEditorClass(this), EcoreModelEditPartFactory
