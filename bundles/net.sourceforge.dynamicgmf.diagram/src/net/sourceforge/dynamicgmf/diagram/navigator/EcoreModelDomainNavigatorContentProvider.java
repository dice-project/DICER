 ...
 * @generated
 */
public class EcoreModelDomainNavigatorContentProvider implements
	 ...
	 * @generated
	 */
	public EcoreModelDomainNavigatorContentProvider() {
	...
	public Object[] getChildren(Object parentElement) {
		...
		if (parentElement instanceof EcoreModelDomainNavigatorItem) {
			return wrapEObjects(myAdapterFctoryContentProvier
					.getChildren(((EcoreModelDomainNavigatorItem) parentElement)
	...
	public Object[] wrapEObjects(Object[] objects, Object parentElement) {
		...
		for (int i = 0; i < objects.length; i++) {
			if (objects[i] instanceof EObject) {
				result.add(new EcoreModelDomainNavigatorItem((EObject) objects[i],
