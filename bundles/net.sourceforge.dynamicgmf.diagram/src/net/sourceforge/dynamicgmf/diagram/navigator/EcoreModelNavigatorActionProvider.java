 ...
 * @generated
 */
public class EcoreModelNavigatorActionProvider extends CommonActionProvider {
	...
	private class OpenDiagramAction extends Action {
		...
		public final void selectionChanged(IStructuredSelection selection) {
			...
			if (selection.size() == 1) {
				...
				if (selectedElement instanceof EcoreModelNavigatorItem) {
					selectedElement = ((EcoreModelNavigatorItem) selectedElement)
							.getView();
				...
				if (selectedElement instanceof Diagram) {
					...
					if (RootEditPart.MODEL_ID
							.equals(EcoreModelVisualIDRegistry.getModelID(diagram))) {
						myDiagram = diagram;
					}
				}
			}
		...
		public void run() {
			...
			try {
				...
				page.openEditor(
						editorInput,
						"xml_diagram".equals(uri.fileExtension()) ?
								"net.sourceforge.dynamicgmf.diagram.part.XMLReflectiveDiagramEditorID" :
								"net.sourceforge.dynamicgmf.diagram.part.ReflectiveDiagramEditorID");
