...
public class EcoreModelNavigatorLinkHelper implements ILinkHelper {
	...
	public IStructuredSelection findSelection(IEditorInput anInput) {
		IDiagramDocumentProvider documentProvider =
			anInput.getName().endsWith("xml_diagram") ?
				new EcoreModelDocumentProvider.XML() :
				new EcoreModelDocumentProvider();
	...
	public void activateEditor(IWorkbenchPage aPage,
		...
		EcoreModelAbstractNavigatorItem abstractNavigatorItem = (EcoreModelAbstractNavigatorItem) aSelection
				.getFirstElement();
		View navigatorView = null;
		if (abstractNavigatorItem instanceof EcoreModelNavigatorItem) {
			navigatorView = ((EcoreModelNavigatorItem) abstractNavigatorItem)
					.getView();
			...
			if (navigatorGroup.getParent() instanceof EcoreModelNavigatorItem) {
				navigatorView = ((EcoreModelNavigatorItem) navigatorGroup.getParent())
						.getView();
			}
		}
