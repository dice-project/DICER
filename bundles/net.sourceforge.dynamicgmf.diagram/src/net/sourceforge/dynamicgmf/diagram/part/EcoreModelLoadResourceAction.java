 ...
 * @generated
 */
public class EcoreModelLoadResourceAction implements IObjectActionDelegate {

	/**
	 * @generated
	 */
	private RootEditPart mySelectedElement;
	...
	public void selectionChanged(IAction action, ISelection selection) {
		...
		if (selection instanceof IStructuredSelection) {
			...
			if (structuredSelection.size() == 1
					&& structuredSelection.getFirstElement() instanceof RootEditPart) {
				mySelectedElement = (RootEditPart) structuredSelection
						.getFirstElement();
			}
		}
