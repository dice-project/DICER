...
mvn install:install-file -Dfile=../lib/es.unizar.disco.dice.static.profile_0.12.5.201706151739.jar -DgroupId=es.unizar.disco.dice.static \
    -DartifactId=profile -Dversion=0.12.5 -Dpackaging=jar
