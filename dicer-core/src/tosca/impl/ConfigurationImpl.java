 ...
 * </p>
 * <ul>
 *   <li>{@link tosca.impl.ConfigurationImpl#getProperty_name <em>Property name</em>}</li>
 *   <li>{@link tosca.impl.ConfigurationImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConfigurationImpl extends MinimalEObjectImpl.Container implements Configuration {
    ...
    protected EClass eStaticClass() {
        return ToscaPackage.Literals.CONFIGURATION;
    }
    ...
    public void setProperty_name(String newProperty_name) {
        ...
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ToscaPackage.CONFIGURATION__PROPERTY_NAME, oldProperty_name, property_name));
    }
    ...
    public void setValue(String newValue) {
        ...
        value = newValue;
        if (eNotificationRequired())
            eNotify(new ENotificationImpl(this, Notification.SET, ToscaPackage.CONFIGURATION__VALUE, oldValue, value));
    }
    ...
    public Object eGet(int featureID, boolean resolve, boolean coreType) {
        switch (featureID) {
            case ToscaPackage.CONFIGURATION__PROPERTY_NAME:
                return getProperty_name();
            case ToscaPackage.CONFIGURATION__VALUE:
                return getValue();
        }
